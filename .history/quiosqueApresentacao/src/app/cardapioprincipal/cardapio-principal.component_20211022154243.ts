...
export class CardapioPrincipalComponent implements OnInit {
  ...
  element1: HTMLElement = 0;
  element2: HTMLElement = 0;
  element3: HTMLElement = 0;
  element4: HTMLElement = 0;
  element5: HTMLElement = 0;
  element6: HTMLElement = 0;
  element7: HTMLElement = 0;
  element8: HTMLElement = 0;
